...
import { projectsData, Project, GITHUB } from "@/constants";
...
export default function DeveloperProjects() {
  ...
  useEffect(() => {
    async function fetchRepos() {
      try {
        const res = await fetch(`https://api.github.com/users/${GITHUB.username}/repos?sort=updated&per_page=100`);
  ...
  return (
    <section className="relative pt-36 pb-20 lg:pb-28 lg:pt-52">
      ...
      <main className="min-h-screen pl-6 pr-6 max-w-6xl mx-auto">
        ...
        <ul ref={ref} className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {isLoading ? (
